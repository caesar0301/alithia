...
1. API Search (with date range)
2. RSS Feed (without date range) 
3. Web Scraper (fallback)
"""
...
class TestArxivPaperFetcherWebScraper:
    ...
    def test_web_scraper_enabled(self):
        ...
        result = fetcher._fetch_with_web_scraper(
            arxiv_query="cs.AI",
            max_results=5
        )
...
class TestConvenienceFunction:
    """Integration tests for the convenience function fetch_arxiv_papers."""

    @pytest.mark.integration
    def test_fetch_arxiv_papers_with_api_search(self):
        """Test convenience function with API search."""
        yesterday = datetime.now() - timedelta(days=1)
        from_time = yesterday.strftime("%Y%m%d") + "0000"
        to_time = yesterday.strftime("%Y%m%d") + "2359"
    ...
    def test_fetch_arxiv_papers_with_rss_feed(self):
        """Test convenience function with RSS feed."""
        papers = fetch_arxiv_papers(
            arxiv_query="cs.AI",
            from_time=None,
            to_time=None,
    ...
    def test_fetch_arxiv_papers_with_web_fallback(self):
        """Test convenience function with web fallback enabled."""
        papers = fetch_arxiv_papers(
            arxiv_query="cs.AI",
            from_time=None,
            to_time=None,
    ...
    def test_fetch_arxiv_papers_max_retries(self):
        """Test convenience function with custom max_retries."""
        papers = fetch_arxiv_papers(
            arxiv_query="cs.AI",
            from_time=None,
            to_time=None,
            debug=True,
            max_retries=1,  # Lower retries for faster test
        )
    ...
    def test_fetch_arxiv_papers_raises_on_all_failures(self):
        """Test that convenience function raises error when all strategies fail."""
        # Use invalid category that should fail all strategies
