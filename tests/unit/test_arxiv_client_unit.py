...
class TestArxivClientUnit:
    ...
    def test_get_arxiv_papers_debug_mode_mocked(self):
        ...
        with patch("alithia.arxrec.arxiv_paper.arxiv") as mock_arxiv:
    ...
    def test_get_arxiv_papers_invalid_query_mocked(self):
        ...
        with patch("alithia.arxrec.arxiv_paper.feedparser") as mock_feedparser:
    ...
    def test_get_arxiv_papers_with_papers_mocked(self):
        ...
        with (
            patch("alithia.arxrec.arxiv_paper.feedparser") as mock_feedparser,
            patch("alithia.arxrec.arxiv_paper.arxiv") as mock_arxiv,
        ):
            mock_feedparser.parse.return_value = mock_feed
