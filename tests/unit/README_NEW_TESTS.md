...
### 1. `test_paper_fetcher.py` (18 tests)

Tests for the enhanced paper fetcher with automatic fallback strategies.
...
pytest tests/unit/test_paper_fetcher.py::test_fetch_papers_rss_fallback -v

# Test web scraper as last resort
pytest tests/unit/test_paper_fetcher.py::test_fetch_papers_web_scraper_fallback -v

# Test retry logic
pytest tests/unit/test_paper_fetcher.py::test_fetch_with_api_search_retry_logic -v
```
...
- `paper_fetcher.py`: ~95% line coverage
...
```bash
# Quick test
pytest tests/unit/test_paper_fetcher.py -x
...
```bash
pytest tests/unit/test_paper_fetcher.py -vv
```

### Run with Print Statements
```bash
pytest tests/unit/test_paper_fetcher.py -s
```

### Run with Debug Mode
```bash
pytest tests/unit/test_paper_fetcher.py --pdb
```
