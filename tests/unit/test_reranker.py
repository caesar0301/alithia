...
def test_rerank_sentence_transformer_papers_without_summary(sample_corpus):
    ...
    papers = [
        ArxivPaper(
            title="Paper 1", summary="Valid summary", authors=["Author 1"], arxiv_id="2312.00001", pdf_url="url1"
        ),
        ArxivPaper(
            title="Paper 2", summary="", authors=["Author 2"], arxiv_id="2312.00002", pdf_url="url2"  # Empty summary
        ),
        ArxivPaper(
            title="Paper 3",
...
def test_rerank_sentence_transformer_time_decay():
    ...
    corpus = [
        {"data": {"abstractNote": "Old paper about ML", "dateAdded": "2023-01-01T10:00:00Z"}},  # Old
        {"data": {"abstractNote": "Recent paper about ML", "dateAdded": "2023-12-01T10:00:00Z"}},  # Recent
    ]
...
def test_scored_paper_updates_paper_score():
    ...
    paper = ArxivPaper(title="Test", summary="Abstract", authors=["Author"], arxiv_id="2312.00001", pdf_url="url")
